...
func main() {
	...
	//cfg.HttpHosts = "dogfooter.io:7977"
	if len(*hostsAddr) == 0 {
	...
	services = append(services, "GetPlatform")
	services = append(services, "GetSystemType")
	services = append(services, "GetUserStatus")
	...
	services = append(services, "PrepareImage")
	services = append(services, "UploadImage")
	services = append(services, "GetImageUri")
	services = append(services, "ProcessImage")
	services = append(services, "GetThumbnailUri")
	services = append(services, "CreateHospital")
	services = append(services, "AddPatient")
	services = append(services, "AddDiagnosis")
	services = append(services, "AddDate")
	services = append(services, "GetPatient")
	services = append(services, "GetDiagnosis")
	services = append(services, "GetDate")
	services = append(services, "SearchPatient")
	services = append(services, "SearchDisease")
	services = append(services, "SearchDate")
	services = append(services, "GetImagesInEachDate")
	services = append(services, "MoveImagesToLibrary")
	services = append(services, "MoveImagesToDate")
	services = append(services, "GetPlaygroundDate")
	services = append(services, "GetUserInformation")
	services = append(services, "GetLibraryImages")
	services = append(services, "ListEthnicity")
	services = append(services, "AddEthnicity")
	services = append(services, "DelEthnicity")
	services = append(services, "SetDefaultEthnicity")
	services = append(services, "ListCountry")
	services = append(services, "AddCountry")
	services = append(services, "DelCountry")
	services = append(services, "SetDefaultCountry")
	services = append(services, "ListSkin")
	services = append(services, "AddSkin")
	services = append(services, "DelSkin")
	services = append(services, "SetDefaultSkin")
	services = append(services, "ListDisease")
	services = append(services, "AddDisease")
	services = append(services, "DelDisease")
	services = append(services, "SetDefaultDisease")
	services = append(services, "ListLocation")
	services = append(services, "AddLocation")
	services = append(services, "DelLocation")
	services = append(services, "SetDefaultLocation")
	services = append(services, "ListGender")
	services = append(services, "AddGender")
	services = append(services, "DelGender")
	services = append(services, "SetDefaultGender")
	services = append(services, "ListTag")
	services = append(services, "AddTag")
	services = append(services, "DelTag")
	services = append(services, "SetDefaultTag")
	services = append(services, "GetSlaveInformation")
	services = append(services, "SignInSlave")
	services = append(services, "GetLastDateInEachDiagnosis")
	services = append(services, "GetLastDateInEachPatient")
	services = append(services, "GetLastDiagnosis")
	services = append(services, "GetDiskUsage")
	services = append(services, "GetImage")
	services = append(services, "UpdateImage")
	services = append(services, "GetWebsocketHost")
	services = append(services, "UpdatePatient")
	services = append(services, "GetImagesInLive")
	services = append(services, "UpdateImage3D")
	...
	for {
		...
		case "SearchDate":
			SearchDate()
		case "GetImagesInEachDate":
			GetImagesByDate()
		case "MoveImagesToLibrary":
			MoveImagesToLibrary()
		case "MoveImagesToDate":
			MoveImagesToDate()
		case "GetPlaygroundDate":
			GetPlaygroundDate()
		case "GetUserInformation":
			GetUserInformation()
		case "GetLibraryImages":
			GetLibraryImages()
		case "ListEthnicity":
			ListEthnicity()
		case "AddEthnicity":
		...
		case "SetDefaultTag":
			SetDefaultTag()
		case "GetSlaveInformation":
			GetSlaveInformation()
		case "SignInSlave":
			SignInSlave()
		case "GetLastDateInEachDiagnosis":
			GetLastDateInEachDiagnosis()
		case "GetLastDateInEachPatient":
			GetLastDateInEachPatient()
		case "GetLastDiagnosis":
			GetLastDiagnosis()
		case "GetDiskUsage":
			GetDiskUsage()
		case "GetImage":
...
func AddDiagnosis() (diagnosisId string) {
	if len(tokens) < 9 {
		fmt.Fprintf(os.Stderr, "%s: <service> <access_token> <patient_id>(0: empty) <type>(0: empty) <location>x2 <tag_list>x2 <visit_date>(0: empty)\n", GetFunctionName())
		return
	}
	message := service.Payload{
		Category:    "diagnosis",
