...
type DogfooterPublic struct {
}

func (s *DogfooterPublic) Service(ctx context.Context, req Payload) (res Payload, err error) {
	switch req.Service {
	case "SignUp":
...
func (s *DogfooterPublic) GetCertificationCode(ctx context.Context, req Payload) (res Payload, err error) {
	if len(req.Account) == 0 {
		err = errors.New("'account' is mandatory")
		return
	}
...
func (s *DogfooterPublic) SignUpPassword(ctx context.Context, req Payload) (res Payload, err error) {
	if len(req.Account) == 0 {
		err = errors.New("'account' is mandatory")
		return
	}
...
func (s *DogfooterPublic) GetPlatform(ctx context.Context, req Payload) (res Payload, err error) {
	res = Payload{
		Platform: envOs,
	}
	return
}
func (s *DogfooterPublic) GetSystemType(ctx context.Context, req Payload) (res Payload, err error) {
	res = Payload{
		SystemType: GetConfigSystemType(),
	}
	return
}
func (s *DogfooterPublic) SignUp(ctx context.Context, req Payload) (res Payload, err error) {
	// TODO: 회원가입 절차
...
func (s *DogfooterPublic) SignIn(ctx context.Context, req Payload) (res Payload, err error) {
	// 로그인 정보 체크
	if len(req.Account) == 0 {
		err = errors.New("'account' is mandatory")
		return
...
func (s *DogfooterPublic) VerifyCertificationCode(ctx context.Context, req Payload) (res Payload, err error) {
	if len(req.Account) == 0 {
		err = errors.New("'account' is mandatory")
		return
	}
...
func (s *DogfooterPublic) ResendCertificationCode(ctx context.Context, req Payload) (res Payload, err error) {
	// 인자 체크
	if len(req.Account) == 0 {
		err = errors.New("'account' is mandatory")
		return
...
func (s *DogfooterPublic) UpdatePassword(ctx context.Context, req Payload) (res Payload, err error) {
	// 인자 체크
	if len(req.Account) == 0 {
		err = errors.New("'account' is mandatory")
		return
...
func (s *DogfooterPublic) GetDiskUsage(ctx context.Context, req Payload) (res Payload, err error) {
