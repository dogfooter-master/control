...
const (
	homepageUrl = "https://www.dogfooter.io"
)
          ...
          <tr>
            <td align="center" valign="top" style="padding: 36px 24px;">
              <a href="` + homepageUrl + `" target="_blank" style="display: inline-block;">
                <img src="cid:workdomo-logo@2x.png" alt="Logo" border="0" width="48" style="display: block; width: 396px; max-width: 396px; min-width: 396px;">
              </a>
            </td>
          </tr>
        </table>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td align="center" bgcolor="#1a82e2" style="border-radius: 6px;">
                          <a href="` + t.Url + `" target="_blank" style="display: inline-block; padding: 16px 36px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; color: #ffffff; text-decoration: none; border-radius: 6px;">Change Password</a>
                        </td>
                      </tr>
                    </table>
                  </td>
    ...
    <tr>
      <td align="center" bgcolor="#e9ecef" style="padding: 24px;">
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          ...
          <tr>
            <td align="center" bgcolor="#e9ecef" style="padding: 12px 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 20px; color: #666;">
              <p style="margin: 0;">TODO: 워크도모 주소</p>
            </td>
          </tr>
          <!-- end unsubscribe -->
